    ...
    public static class QuirkDefinitions
    {
        ...
        public static List<QuirkModel> Misc()
        {
            var list = new List<QuirkModel>{
                 ...
                 new QuirkModel{Description = "Constantly quotes favorite epic sagas and can usually identify the saga that a quote may come from."},
                 new QuirkModel{Description = "Is an overly honest person, always telling the truth even to his or her own detriment."},
